...
class Aliconfig {
    ...
    public function __construct() {
        ...
        //↑↑↑↑↑↑↑↑↑↑请在这里配置您的基本信息↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
        //签名方式 不需修改
        $this->alipay_config['sign_type'] = \Yii::$app->params['alipay']['sign_type'];//strtoupper('MD5');

        //字符编码格式 目前支持 gbk 或 utf-8
        $this->alipay_config['input_charset'] =  \Yii::$app->params['alipay']['input_charset'];//strtolower('utf-8');
        ...
        $this->alipay_config['transport'] = \Yii::$app->params['alipay']['transport'];//'http';
    }
